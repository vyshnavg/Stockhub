<div class="container"> 
    ...
    <h3 style="color:black;">StockHub is a raw material finder and procurement website which aids future and present manufacturers create links with vendors all across the country. It is an online platform for the manufacturing industry.</h3>

    <hr>
    
    <h2>How does it work?</h2>
    
    <h3>The people who want to find out the raw materials required to make the end-product can do so by just typing out the name of the product in the  <a href="<?php echo base_url();?>home">homepage</a>.<br><br> 
