...
<br>
    ...
    <hr>
    <h4>The people who want to find out the raw materials required to make the end-product can do so by just typing out the name of the product in the  <a href="<?php echo base_url();?>home">homepage</a>.<br><br> 
