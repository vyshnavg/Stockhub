...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 29, 2018 at 10:17 AM
...
(2, 'Karnataka', 'Bangalore', '25th Street', '200', NULL, 680625, 'India');
...
INSERT INTO `users` (`m_id`, `m_firstname`, `m_lastname`, `m_email`, `m_username`, `m_password`, `m_address_id`, `m_org_name`, `m_status`, `register_date`) VALUES
(2, 'Jack', 'Doe', 'jack@google.com', 'jackdoe12', '0a80250fe4bbd7759207d6bff43c8661', 1, NULL, 'Active', '2018-01-10 06:12:54'),
...
INSERT INTO `vendors` (`v_id`, `v_email`, `v_username`, `v_password`, `v_firstname`, `v_lastname`, `v_address_id`, `v_org_name`, `v_website`, `v_exprt_mthd`, `created_at`) VALUES
(1, 'sam@time.in', 'samlaw12', '0a80250fe4bbd7759207d6bff43c8661', 'Sam', 'Lawrence', NULL, NULL, NULL, NULL, '2018-01-05 05:48:32');
...
--
ALTER TABLE `m_address_dict`
  MODIFY `m_address_dict_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
